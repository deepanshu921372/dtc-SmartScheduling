...
import MenuIcon from "@mui/icons-material/Menu";  // Added import
import CloseIcon from "@mui/icons-material/Close";  // Added import
  ...
  return (
    <Box sx={{ display: "flex", minHeight: "75vh", overflow: 'hidden' }}>
      ...
      >
        ...
        <TableContainer
          component={Paper}
          sx={{ maxWidth: "600px", marginBottom: 3 }}
        >
        ...
        <Typography variant="body1" sx={{ marginBottom: 2 }}>
          To make changes to Bus Demand, Crew, etc. follow the given
          instructions -
        </Typography>
        <Box sx={{ display: "flex", gap: 2, marginBottom: 3 }}>
          <Select
            defaultValue=""
            displayEmpty
            sx={{ width: "200px", backgroundColor: "#74c0fc" }}
          >
